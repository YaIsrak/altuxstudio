  ...
  return (
    <BlurFade>
      <section className="container mx-auto px-4 py-[15vmin]" id="about">
        ...
        <BlurFade delay={0} className="text-muted-foreground max-w-lg text-sm">
        ...
        <BlurFade
          delay={0.1}
          className="border-primary relative mx-auto mt-12 max-w-sm border p-8 md:max-w-3xl lg:max-w-4xl"
        >
          {/* points */}
          <>
          ...
          <p className="text-lg font-extralight italic md:text-xl">
            <span className="font-bold">“We don’t just build websites</span> -
            we create digital ecosystems where brands thrive. With every
            project, we prioritize innovation, ensuring that our solutions are{" "}
            <span className="font-bold">scalable, fast, and future-proof</span>.
            From sleek UI/UX design to powerful backend development, we make
            sure your brand’s online journey is{" "}
